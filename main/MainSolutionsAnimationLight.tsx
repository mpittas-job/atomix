...
function GradientIcon({ name }: { name: string }) {
  const mask = `url("${ICON_MASK_URL(name)}")`;
  return (
    <span
      className="inline-block h-8 w-8 shrink-0 bg-gradient-to-br from-[#0693B9] to-[#39C6ED]"
      style={{
...
function IconText({ icon, text }: { icon: string; text: string }) {
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <p className="text-md font-semibold text-[#011F27] text-center">{text}</p>
    </div>
  );
}
...
function SquareBadge({ text }: { text: string }) {
  return (
    <div className="relative w-full overflow-hidden rounded-lg bg-white/40 px-3 py-2 text-center shadow-[inset_0_1px_2px_rgba(255,255,255,0.6),inset_3px_3px_12px_rgba(10,21,44,0.06)] backdrop-blur-md border border-white">
      ...
      <p className="relative text-sm font-bold text-[#011F27]">{text}</p>
    </div>
  );
}

function SolutionsIconBoxLight({
  iconName,
  title,
  description,
  className = "",
  ...
  return (
    <IconBoxLight className={className}>
...
export default function MainSolutionsAnimationLight() {
        ...
        <div ref={containerRef}>
          ...
          <div className="grid grid-cols-6 gap-4">
            ...
            <div className="col-span-1 flex flex-col items-center gap-y-3 relative">
              <div ref={iconText1Ref}>
                <IconText
                  icon="https://api.iconify.design/lucide:cpu.svg?color=%23011f27"
                  text="AI"
                />
              </div>
            ...
            <div className="col-span-4 flex flex-col items-center gap-y-3">
              <div ref={iconText2Ref}>
                <IconText
                  icon="https://api.iconify.design/lucide:brain-circuit.svg?color=%23011f27"
            ...
            <div className="col-span-1 flex flex-col items-center gap-y-3">
              <div ref={iconText3Ref}>
                <IconText
                  icon="https://api.iconify.design/lucide:link.svg?color=%23011f27"
                  text="Blockchain"
                />
              </div>
              <div className="h-[72px] w-[2px] mx-auto">
          ...
          <div className="grid grid-cols-6 gap-4 relative z-10">
            <div ref={row2Box1Ref} className="col-span-1 relative">
              <SolutionsIconBoxLight
                iconName="file-check"
                title="Rule first architecture"
                description="Uses AI to build loan products. The system builds optimal workflows automatically."
